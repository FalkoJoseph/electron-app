...
>(({ className, color, ...props }, ref) => {
  ...
  return (
    <SwitchPrimitives.Root
      className={cn(
        "dark:data-[state=unchecked]:shadow-inner-border data-[state=unchecked]:shadow-inner data-[state=checked]:shadow-inner-border peer bg-gradient-to-t inline-flex h-[21px] w-9 shrink-0 items-center focus:outline-none rounded-full disabled:cursor-not-allowed disabled:opacity-50",
    ...
    >
      <SwitchPrimitives.Thumb
        className={cn(
          "pointer-events-none block h-4 w-4 rounded-full bg-white shadow ring-0 transition-transform data-[state=checked]:translate-x-[17px] data-[state=unchecked]:translate-x-[3px]",
        )}
      />
    </SwitchPrimitives.Root>
  );
